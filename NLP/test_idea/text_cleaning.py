...
#
#     # if possible_answer or possible_answer2 is either not null, then return the not null one
#     if possible_answer:
#         if possible_answer2:
#             if possible_answer[0].count < possible_answer2[0].count:
#                 return possible_answer[0].term
#             else:
#                 return possible_answer2[0].term
#         else:
#             return possible_answer[0].term
#
#     return word
...
for text in text_list:
    ...
    possible_answer2 = symSpell2.lookup_compound(text, max_edit_distance=2)
    for suggestion in possible_answer2:
        print(f"Corrected: {suggestion.term}, Confidence: {suggestion.distance}")
    if possible_answer2:
        text = possible_answer2[0].term
    else:
        text = text
